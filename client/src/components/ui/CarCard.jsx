        ...
        <div className="glass-card group overflow-hidden">
            ...
            <div className="p-6 relative z-20">
                ...
                <div className="flex justify-between items-center mt-6 pt-5 border-t border-white/10">
                    <div>
                        <span className="text-2xl font-black text-white">{car.price} <span className="text-xs font-medium text-zinc-400">TND/J</span></span>
                    </div>

                    <button className="bg-white text-black hover:bg-brand-primary hover:text-white px-6 py-2.5 rounded-xl text-xs font-black uppercase tracking-wider transition-all shadow-xl shadow-black/10 active:scale-95">
                        Détails
                    </button>
                </div>
            </div>
